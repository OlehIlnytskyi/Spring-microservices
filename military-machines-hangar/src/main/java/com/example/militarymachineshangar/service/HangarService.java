...
import com.example.militarymachineshangar.repository.MachineRepository;
...
//        isDataInserted = true;
    ...
    public Catalog<Machine> getAll() {
        return new Catalog<>(machineRepository.findAll());
    }
    ...
    public void edit(Machine newMachineData) {
        ...
        // Result: editing data
        machineRepository.save(newMachineData);
    }
